...
fn layout_pass(
    ...
    for r in run_floats.chunks_exact(RUN_STRIDE) {
        runs.push(crate::layout::Run { kind: r[0] as u8, font: r[1] as i32, size: r[2], ls: r[3], ws: r[4], line_height: r[5], asc: r[7], metric: r[6], ws_mode: r[8] as u8 });
    }

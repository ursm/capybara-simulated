(() => {
  ...
  __name(tokenizeSelector, "tokenizeSelector");
  ...
  __name(parseAttrToken, "parseAttrToken");
  ...
  __name(parsePseudoToken, "parsePseudoToken");
  function parseNth(s) {
  ...
  __name(parseComplex, "parseComplex");
  ...
  __name(parseCompound, "parseCompound");
  ...
  __name(hasMatchInDescendants, "hasMatchInDescendants");
  ...
  __name(matchPseudo, "matchPseudo");
  ...
  var adapter = {
    ...
    getText: /* @__PURE__ */ __name((n) => n.textContent, "getText"),
    ...
    isHovered: /* @__PURE__ */ __name(() => false, "isHovered"),
  ...
  __name(normaliseScopedSelector, "normaliseScopedSelector");
  ...
  function installHtmlParser({ Document: Document2, Element: Element2, Text: Text2, DocumentFragment: DocumentFragment2 }) {
    ...
    function wrapLooseTrs(table) {
      ...
      if (!kids) return;
      const isWs = /* @__PURE__ */ __name((k) => k.nodeType === NODE_TEXT && /^\s*$/.test(String(k.data || "")), "isWs");
  ...
  __name(parseCssBody, "parseCssBody");
  ...
  __name(scanToBreaker, "scanToBreaker");
  ...
  __name(parseAtRule, "parseAtRule");
  ...
  __name(skipBalancedBlock, "skipBalancedBlock");
  ...
  __name(parseDeclsAndNested, "parseDeclsAndNested");
      ...
      for (const node of nodes) {
        if (node.type === "at-rule") {
          ...
          if (node.name === "supports") {
            if (!supportsMatches(node.prelude)) continue;
            if (node.decls && node.decls.length && stack.length) {
              out.push({ selectorText: stack[stack.length - 1], decls: node.decls });
            }
            walk2(node.children || []);
  ...
  __name(flattenCssTree, "flattenCssTree");
  ...
  function collectCascadeRules(doc) {
    ...
    const hide = [];
    const layout = [];
    const append = /* @__PURE__ */ __name((sheet) => {
  ...
  function makeTagCtor(tagName, Element2) {
    ...
    Object.defineProperty(ctor, Symbol.hasInstance, {
      value: /* @__PURE__ */ __name((obj) => obj != null && obj._tag === tagName, "value")
    });
    return ctor;
  }
  ...
  function ensurePreInsertionValidity(node, parent, child) {
    if (parent.nodeType !== NODE_DOC && parent.nodeType !== NODE_FRAGMENT && parent.nodeType !== NODE_ELEMENT) {
      throw new globalThis.DOMException(
        `Cannot add a child to a ${nodeTypeName(parent)} node`,
    ...
    if (t !== NODE_FRAGMENT && t !== NODE_ELEMENT && t !== NODE_TEXT && t !== NODE_COMMENT) {
      throw new globalThis.DOMException(
        `Cannot insert a ${nodeTypeName(node)} node`,
        "HierarchyRequestError"
      );
    }
    if (t === NODE_TEXT && parent.nodeType === NODE_DOC) {
      throw new globalThis.DOMException(
        "A Text node cannot be inserted into a Document",
        "HierarchyRequestError"
      );
    }
  }
  ...
  var Element = class _Element extends Node {
    ...
    getElementsByTagName(tag) {
      ...
      return htmlCollection(all.filter((n) => {
        ...
        return htmlDoc ? n._ns === HTML_NS ? asciiLower(qn) === qLower : qn === q : qn === q;
      }));
    }
    ...
    getElementsByTagNameNS(_ns, local) {
      return this.getElementsByTagName(local);
    }
    getAttributeNodeNS(_ns, name) {
  ...
  __name(makeTokenList, "makeTokenList");
  ...
  var Document = class _Document extends Node {
    ...
    getElementsByClassName(cls) {
      ...
      const has = /* @__PURE__ */ __name((el) => wanted.every((c) => classes(el).includes(c)), "has");
    ...
    get implementation() {
      return {
        createHTMLDocument: /* @__PURE__ */ __name((title) => {
  ...
  (function() {
    ...
    function parseXMLDocument(xml) {
      ...
      const src = String(xml == null ? "" : xml).replace(/^﻿/, "").replace(/^\s*<\?xml[^>]*\?>/i, "").replace(/<!DOCTYPE[^>]*>/i, "");
      for (const n of parseFragment(src)) {
        n._parent = doc;
        doc._children.push(n);
        if (n.nodeType === 1 && !doc.documentElement) doc.documentElement = n;
      }
      return doc;
    }
    ...
    globalThis.__csimFrameWindow = function(frameEl) {
      ...
      let body = "", contentType = "text/html";
      ...
      const isXml = ct === "application/xml" || ct === "text/xml" || ct === "application/xhtml+xml" || ct === "image/svg+xml";
      const doc = isXml ? parseXMLDocument(body) : parseDocument(String(body));
    ...
    globalThis.__csimBootContext = function(opts) {
      ...
      return globalThis.__csimLoadDocument(opts.html);
    };

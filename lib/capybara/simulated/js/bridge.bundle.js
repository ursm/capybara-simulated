(() => {
  ...
  for (const __p of ["shadowRootMode", "shadowRootDelegatesFocus", "shadowRootClonable", "shadowRootSerializable", "shadowRootSlotAssignment", "shadowRootAdoptedStyleSheets"]) {
    const __d = Object.getOwnPropertyDescriptor(Element.prototype, __p);
    if (__d) Object.defineProperty(Element.prototype, __p, { ...__d, enumerable: true });
  }
  ...
  function resetFocusIfUnfocusableAfterMove() {
    ...
    const ae = doc && doc._activeElement;
    if (!ae) return;
    if (isFocusable(ae) && !inInertSubtree(ae)) return;
  ...
  (function() {
    ...
    globalThis.__csimFrameWindow = function(frameEl) {
      ...
      let body = "", contentType = "text/html", frameUrl = "", frameCharset = null;

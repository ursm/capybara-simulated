(() => {
  ...
  var Node = class {
    ...
    focus() {
      ...
      if (prev) {
        try {
          dispatchEvent(prev, new FocusEvent("blur", { bubbles: false, cancelable: false, relatedTarget: this }));
        } catch (_) {
        }
        try {
          dispatchEvent(prev, new FocusEvent("focusout", { bubbles: true, cancelable: false, relatedTarget: this }));
        } catch (_) {
        }
      }
      ...
      try {
        dispatchEvent(this, new FocusEvent("focus", { bubbles: false, cancelable: false, relatedTarget: prev }));
      } catch (_) {
      }
      try {
        dispatchEvent(this, new FocusEvent("focusin", { bubbles: true, cancelable: false, relatedTarget: prev }));
      } catch (_) {
      }
    }
    blur() {
      ...
      try {
        dispatchEvent(this, new FocusEvent("blur", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
      try {
        dispatchEvent(this, new FocusEvent("focusout", { bubbles: true, cancelable: false }));
      } catch (_) {
      }
    }
  ...
  function resetFocusIfUnfocusableAfterMove() {
    ...
    globalThis.setTimeout(() => {
      ...
      try {
        dispatchEvent(ae, new FocusEvent("blur", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
      try {
        dispatchEvent(ae, new FocusEvent("focusout", { bubbles: true, cancelable: false }));
      } catch (_) {
      }
    }, 0);
  }

(() => {
  ...
  var Element = class _Element extends Node {
    ...
    get cols() {
      return this._tag === "textarea" ? reflectLimitedUnsignedLongGet(this._attrs.cols, 20) : void 0;
    }
    set cols(v) {
      if (this._tag === "textarea") reflectLimitedUnsignedLongFallbackSet(this, "cols", v, 20);
    }
    get rows() {
      return this._tag === "textarea" ? reflectLimitedUnsignedLongGet(this._attrs.rows, 2) : void 0;
    }
    set rows(v) {

(() => {
  ...
  var REFLECT_STRING_TABLE = [
    ["bgColor", "bgcolor", ["marquee", "table", "tr", "td", "th", "body"], 1],
    ...
    ["border", "border", ["table", "img", "object"], 1],
    ["frame", "frame", ["table"]],
    ["rules", "rules", ["table"]],
  ...
  installReflectedTail(
    ...
    (idl, attr, tagSet, legacyNull) => function(v) {
      if (tagSet.has(this._tag)) this.setAttribute(attr, legacyNull ? v === null ? "" : String(v) : String(v));

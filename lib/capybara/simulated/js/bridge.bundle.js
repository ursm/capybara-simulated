(() => {
  ...
  var Element = class _Element extends Node {
    ...
    set cite(v) {
      if (CITE_REFLECTING_TAGS.has(this._tag)) this.setAttribute("cite", String(v));
    }
    get poster() {
      return reflectURLAttr(this, "poster", POSTER_REFLECTING_TAGS);
    }
    set poster(v) {
      if (this._tag === "video") this.setAttribute("poster", String(v));
    }
    get longDesc() {
      return reflectURLAttr(this, "longdesc", LONGDESC_REFLECTING_TAGS);
    }
    set longDesc(v) {
      if (LONGDESC_REFLECTING_TAGS.has(this._tag)) this.setAttribute("longdesc", String(v));
    }
    ...
    set data(v) {
      if (this._tag === "object") this.setAttribute("data", String(v));
    ...
    set codeBase(v) {
      if (this._tag === "object") this.setAttribute("codebase", String(v));
    ...
    set lowsrc(v) {
      if (this._tag === "img") this.setAttribute("lowsrc", String(v));
    }
    set src(v) {
      const next = String(v);
    ...
    set formAction(v) {
      this.setAttribute("formaction", String(v));
    }
    ...
    set ping(v) {
      this.setAttribute("ping", String(v));
    }

(() => {
  ...
  for (const [k, v] of [["NONE", 0], ["CAPTURING_PHASE", 1], ["AT_TARGET", 2], ["BUBBLING_PHASE", 3]]) {
    Object.defineProperty(Event2, k, { value: v, enumerable: true });
    Object.defineProperty(Event2.prototype, k, { value: v, enumerable: true });
  }
  ...
  var UIEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var ProgressEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var PopStateEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      this.state = init && "state" in init ? init.state : null;
    }
  };
  var HashChangeEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var StorageEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var AnimationEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var TransitionEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      init = init || {};
  ...
  var FormDataEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      this.formData = init && init.formData || null;
    }
  };
  var BeforeUnloadEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      this.returnValue = "";
    }
  ...
  var SubmitEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      this.submitter = init && init.submitter || null;
    }
  };
  var ClipboardEvent = class extends Event2 {
    constructor(type, init) {
      super(type, init);
      const i = init || {};
      let cd = null;
  ...
  function closeDialog(dlg, returnValue) {
    ...
    try {
      dispatchEvent(dlg, new Event2("close", { bubbles: false, cancelable: false }));
    } catch (_) {
    }
  }
  ...
  function collectCascadeRules(doc) {
    ...
    for (const s of doc.documentElement.querySelectorAll("style")) {
      ...
      if (media && !mediaMatches(media, currentViewport())) continue;
  ...
  var CASCADE_READ_PROPS = /* @__PURE__ */ new Set([
    "color",
    "background-color"
  ]);
  ...
  var Node = class {
    ...
    focus() {
      ...
      if (prev) {
        try {
          dispatchEvent(prev, new Event2("blur", { bubbles: false, cancelable: false }));
        } catch (_) {
        }
        try {
          dispatchEvent(prev, new Event2("focusout", { bubbles: true, cancelable: false }));
        } catch (_) {
        }
      }
      ...
      try {
        dispatchEvent(this, new Event2("focus", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
      try {
        dispatchEvent(this, new Event2("focusin", { bubbles: true, cancelable: false }));
      } catch (_) {
      }
    }
    blur() {
      ...
      try {
        dispatchEvent(this, new Event2("blur", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
      try {
        dispatchEvent(this, new Event2("focusout", { bubbles: true, cancelable: false }));
      } catch (_) {
      }
    }
    ...
    click() {
      try {
        ...
        if (ev.defaultPrevented && isInputControl) {
          ...
          try {
            dispatchEvent(this, new Event2("change", { bubbles: true, cancelable: false }));
          } catch (_) {
          }
        }
  ...
  var Element = class _Element extends Node {
    ...
    showPopover() {
      ...
      try {
        dispatchEvent(this, new Event2("beforetoggle", { bubbles: false, cancelable: true }));
      } catch (_) {
      }
      this._popoverOpen = true;
      try {
        dispatchEvent(this, new Event2("toggle", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
    }
    hidePopover() {
    ...
    select() {
      ...
      try {
        dispatchEvent(this, new Event2("select", { bubbles: true, cancelable: false }));
      } catch (_) {
      }
    }
  ...
  var AbortSignal = class _AbortSignal extends EventTarget {
    ...
    _markAborted(reason) {
      ...
      this.dispatchEvent(new Event2("abort"));
    }
    static abort(reason) {
  ...
  globalThis.__csim_deliverEventSourceEvents = function(events) {
    ...
    for (const e of events) {
      ...
      if (e.type === "__open") {
        if (src.readyState === 0) {
          src.readyState = 1;
          dispatchWithOnHandler(src, new Event2("open"));
          delivered++;
        }
        continue;
      }
  ...
  var FileReader = class extends EventTarget {
    ...
    _fire(type) {
      dispatchWithOnHandler(this, new Event2(type));
    }
  };
  ...
  globalThis.__csimSendKeys = function(h, atoms) {
      ...
      if (a.kind === "text") {
        ...
        if (isModCombo && lowerKey === "v") {
          ...
          if (types.length > 0 || plain || html) {
            const ev = new Event2("paste", { bubbles: true, cancelable: true });
            ev.clipboardData = {
              types,
              files,
              items: types.map((t) => {
    ...
    if (typeable && n._attrs.value !== startValue) {
      dispatchEvent(n, new Event2("change", { bubbles: true, cancelable: false }));
    }
    return true;
  };
  ...
  function __fireSelectChange(sel) {
    ...
    try {
      dispatchEvent(sel, new Event2("change", { bubbles: true, cancelable: false }));
    } catch (_) {
    }
  }
  ...
  function fireWindowScroll() {
    try {
      if (typeof globalThis.document?.dispatchEvent === "function") {
        globalThis.document.dispatchEvent(new Event("scroll", { bubbles: true, cancelable: false }));
      }
    } catch (_) {
    }
  }
  ...
  function notifySelectionChange() {
    ...
    if (!doc) return;
    try {
      dispatchEvent(doc, new Event2("selectionchange", { bubbles: false, cancelable: false }));
    } catch (_) {
    }
  }
  var Selection = class {
  ...
  var XMLHttpRequest = class extends EventTarget {
    ...
    _fireEvent(type, extra) {
      const evt = extra ? new ProgressEvent(type, extra) : new Event2(type);
      dispatchWithOnHandler(this, evt);
    }
  };
  ...
  (function() {
    ...
    globalThis.__csimDispatchEvent = function(h, type, init) {
      ...
      const ctor = MOUSE_EVENT_TYPES.has(typeStr) ? MouseEvent : Event2;
    ...
    function maybeFireLinkLoad(el) {
      ...
      Promise.resolve().then(() => {
        ...
        try {
          el.dispatchEvent(new Event2(ok ? "load" : "error"));
        } catch (_) {
        }
      });
    }
    ...
    globalThis.__csimLoadDocument = function(html) {
      ...
      try {
        dispatchEvent(d, new Event2("readystatechange", { bubbles: false, cancelable: false }));
      } catch (_) {
      }
    ...
    function runInlineScripts(doc) {
      ...
      if (doc) {
        try {
          dispatchEvent(doc, new Event2("DOMContentLoaded", { bubbles: true, cancelable: false }));
        } catch (_) {
        }
      }
    }
    ...
    globalThis.__csimDropOnto = function(h, items) {
      ...
      for (const type of ["dragenter", "dragover", "drop"]) {
        const ev = new Event2(type, { bubbles: true, cancelable: true });
        ev.dataTransfer = dt;
    ...
    globalThis.__csimClickResolve = function(h, modifiers) {
      ...
      }
      {
        ...
        if (details) {
          ...
          try {
            dispatchEvent(details, new Event2("toggle", { bubbles: false }));
          } catch (_) {
          }
        }
      }

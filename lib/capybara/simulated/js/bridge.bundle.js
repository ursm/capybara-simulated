(() => {
  ...
  function __csimRealmGlobalOf(anchor) {
    try {
      if (anchor && globalThis.RustyRacer && typeof globalThis.RustyRacer.contextOf === "function" && typeof globalThis.RustyRacer.contextGlobal === "function") {
        const id = globalThis.RustyRacer.contextOf(anchor);
        if (id != null) {
          const g = globalThis.RustyRacer.contextGlobal(id);

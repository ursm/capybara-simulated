(() => {
  ...
  function shadowTemplate(el, opts) {
    ...
    return '<template shadowrootmode="' + sr.mode + '"' + (sr.delegatesFocus ? ' shadowrootdelegatesfocus=""' : "") + (sr.serializable ? ' shadowrootserializable=""' : "") + (sr.slotAssignment === "manual" ? ' shadowrootslotassignment="manual"' : "") + (sr.clonable ? ' shadowrootclonable=""' : "") + ">" + serializeChildrenWithShadow(sr, opts) + "</template>";
  }

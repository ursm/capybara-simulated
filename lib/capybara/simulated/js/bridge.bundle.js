(() => {
  ...
  var IDBEventTarget = class extends EventTarget {
    dispatchEvent(evt) {
  ...
  var IDBRequest = class extends IDBEventTarget {
    constructor() {
      super();
      this.result = null;
      this.error = null;
  ...
  var IDBDatabase = class extends IDBEventTarget {
    constructor() {
      super();
  ...
  var IDBTransaction = class extends IDBEventTarget {
    objectStore(name) {
      return new IDBObjectStore(name);
    }
  };
  var IDBObjectStore = class extends IDBEventTarget {
    constructor(name) {
      super();
      this._name = name;
    }
  ...
  var IDBIndex = class extends IDBEventTarget {
  };
  var IDBCursor = class {
    advance() {
    }

(() => {
  ...
  function installParse5Adapter({
    ...
    const treeAdapter = {
      ...
      createElement(tagName, namespaceURI, attrs) {
        if (live && (!namespaceURI || namespaceURI === HTML_NS2)) {
        ...
        el._ownerDoc = curDoc;
        if (namespaceURI && namespaceURI !== HTML_NS2) el._ns = namespaceURI;
        applyAttrs(el, attrs);
        return el;
      },
    ...
    function parse5ParseFragment2(html, contextEl) {
      ...
      try {
        let ctx = contextEl;
        if (!ctx || ctx.nodeType !== NODE_ELEMENT || ctx._ns !== HTML_NS2 || ctx._localName === "html") {
          ctx = treeAdapter.createElement("body", HTML_NS2, []);
        }
  ...
  function collectByTagName(scope, tag, htmlDoc) {
    ...
    return collectDescendants(scope, (n) => {
      ...
      return htmlDoc ? n._ns === HTML_NS3 ? qn === qLower : qn === q : qn === q;
    });
  }
  ...
  function attrKey(el, name) {
    const s = String(name);
    return el && el._ns === HTML_NS3 ? asciiLower2(s) : s;
  }
  ...
  function firstAttrKeyByQName(el, name) {
    const want = el._ns === HTML_NS3 ? asciiLower2(String(name)) : String(name);
  ...
  var Element = class _Element extends Node {
    ...
    get tagName() {
      ...
      return this._ns === HTML_NS3 && isHtmlDocument(this.ownerDocument) ? asciiUpper(qn) : qn;
    }
    get nodeName() {
      return this.tagName;
    }
    ...
    get attributes() {
      ...
      const dropUppercase = this._ns === HTML_NS3 && isHtmlDocument(this.ownerDocument);
    ...
    attachInternals() {
      const def = this._ns === HTML_NS3 ? getCustomElementCtor(this._localName) : null;
      if (!def) {
    ...
    get relList() {
      ...
      if (ns === HTML_NS3 && (ln === "a" || ln === "area" || ln === "link" || ln === "form") || ns === SVG_NS && ln === "a") return tokenListFor(this, "rel");
      return void 0;
    }
    get sandbox() {
      return this._ns === HTML_NS3 && this._localName === "iframe" ? tokenListFor(this, "sandbox") : void 0;
    }
    get sizes() {
      return this._ns === HTML_NS3 && this._localName === "link" ? tokenListFor(this, "sizes") : void 0;
    }
    // `htmlFor` is a DOMTokenList on <output> but a plain string ('for'
    // attribute) on <label>; undefined on everything else.
    get htmlFor() {
      if (this._ns !== HTML_NS3) return void 0;
    ...
    get control() {
      if (this._ns !== HTML_NS3 || this._localName !== "label") return void 0;
    ...
    set htmlFor(v) {
      if (this._ns === HTML_NS3 && (this._localName === "label" || this._localName === "output")) {
  ...
  var ElementInternals = class {
    ...
    constructor(target, token) {
      ...
      this._target = target;
      const ctor = target._ns === HTML_NS3 ? getCustomElementCtor(target._localName) : null;
  ...
  function canAttachShadow(el) {
    if (el._ns !== HTML_NS3) return false;
  ...
  function processDeclarativeShadowRoots(root, contextEl = null) {
    ...
    for (const node of root._children.slice()) {
      ...
      if (node._tag === "template" && node._ns === HTML_NS3) {
  ...
  function isHtmlSlot(el) {
    return el._tag === "slot" && el._ns === HTML_NS3;
  }
  ...
  var DOMImplementation = class {
    ...
    createDocument(...args) {
      ...
      d._contentType = ns === HTML_NS3 ? "application/xhtml+xml" : ns === SVG_NS ? "image/svg+xml" : "application/xml";
  ...
  var Document = class extends Node {
    ...
    createElement(tag, options) {
      ...
      const ns = html || this._contentType === "application/xhtml+xml" ? HTML_NS3 : null;
    ...
    _createElement(ns, prefix, localName) {
      let el;
      const ctor = ns === HTML_NS3 ? getCustomElementCtor(localName.toLowerCase()) : null;
      if (ctor) {
  ...
  function xmlSerSerializeElement(node, namespace, prefixMap, refs) {
    ...
    if (ns === HTML_NS3 && kids.length === 0 && XML_SER_VOID.has(xmlSerLocalName(node))) {
      markup += " /";
      skipEndTag = true;
    } else if (ns !== HTML_NS3 && kids.length === 0) {
      markup += "/";
      skipEndTag = true;
    }
    markup += ">";
    if (skipEndTag) return markup;
    if (ns === HTML_NS3 && xmlSerLocalName(node) === "template" && node.content) {
  ...
  function makeTagCtor(name, tag, Element2) {
    ...
    const match = Array.isArray(tag) ? (obj) => obj != null && obj._ns === HTML_NS4 && tag.indexOf(obj._localName) !== -1 : (obj) => obj != null && obj._ns === HTML_NS4 && obj._localName === tag;
  ...
  function installDomClassAliases({ Element: Element2, Document: Document2, Text: Text2 }) {
    ...
    }
    {
      ...
      Object.defineProperty(ctor, Symbol.hasInstance, {
        value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS4 && obj._localName != null && !KNOWN_HTML_TAGS.has(obj._localName), "value")
      });
    ...
    Object.defineProperty(HTMLElement, Symbol.hasInstance, { value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS4, "value") });

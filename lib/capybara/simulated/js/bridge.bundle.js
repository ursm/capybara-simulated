(() => {
  ...
  (function() {
    ...
    class Element extends Node {
      ...
      // CSS query API — backed by css-select v7 (vendored) so the
      // surface tracks the spec and the same matcher serves Ruby's
      // `find_css` (via `__csimQuery`) and any JS-side framework code.
      //
      // Spec note: `Element#querySelectorAll` matches against the
      // element's *descendants only* — the element itself is never
      // returned even when the selector would match it. Pass children
      // as roots, not `this`.
      querySelector(sel) {
        return __csimSelectFirst(this._children, sel);
      }
      querySelectorAll(sel) {
        return __csimSelectAll(this._children, sel);
      }
      matches(sel) {
        return __csimMatchesSelector(this, sel);
      }
      closest(sel) {
        return __csimClosestSelector(this, sel);
      }
    ...
    class Document extends Node {
      ...
      querySelector(sel) {
        return this.documentElement ? __csimSelectFirst([this.documentElement], sel) : null;
      }
      querySelectorAll(sel) {
        return this.documentElement ? __csimSelectAll([this.documentElement], sel) : [];
      }
    ...
    const __cssSelect = globalThis.__csimVendor.cssSelect;
    const __compiledCache = /* @__PURE__ */ new Map();
    const __csimSelectAdapter = {
    ...
    function __csimCompile(sel) {
      const key = __normaliseScopedSelector(sel);
      let fn = __compiledCache.get(key);
      if (fn) return fn;
      try {
        fn = __cssSelect.compile(key, { adapter: __csimSelectAdapter });
      } catch (e) {
        throw new Error("csim: " + (e && e.message ? e.message : e));
      }
      __compiledCache.set(key, fn);
      return fn;
    }
    function __csimSelectAll(roots, sel) {
      return __csimSelectAdapter.findAll(__csimCompile(sel), roots);
    }
    function __csimSelectFirst(roots, sel) {
      return __csimSelectAdapter.findOne(__csimCompile(sel), roots);
    }
    function __csimMatchesSelector(el, sel) {
      return el && el.nodeType === NODE_ELEMENT && __csimCompile(sel)(el);
    }
    function __csimClosestSelector(el, sel) {
      const fn = __csimCompile(sel);
    ...
    globalThis.FileReader = class FileReader extends globalThis.EventTarget {
      ...
      readAsDataURL(blob) {
        this._read(blob, (t) => "data:" + (blob.type || "application/octet-stream") + ";base64," + (__csim_btoa ? __csim_btoa(t) : ""));
      }
      readAsArrayBuffer(blob) {
        this._read(blob, (t) => __csimBytesToArrayBuffer(t));
      }
    ...
    globalThis.createImageBitmap = function(source, optionsOrSx, sy, sw, sh, opts) {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (source instanceof globalThis.Blob) {
          ...
          const bm2 = new globalThis.ImageBitmap();
        ...
        for (let i = 0; i < raw.length; i++) bytes2[i] = raw.charCodeAt(i) & 255;
    ...
    class CanvasRenderingContext2D {
      ...
      measureText(s) {
        return { width: String(s).length * 6, actualBoundingBoxLeft: 0, actualBoundingBoxRight: 0, actualBoundingBoxAscent: 8, actualBoundingBoxDescent: 2 };
      }
    ...
    function __csimMakeStorage(kind) {
      return {
        get length() {
          return __csim_storageLength(kind);
        },
        key(i) {
        ...
        setItem(k, v) {
          __csim_storageSet(kind, String(k), String(v == null ? "" : v));
        },
        removeItem(k) {
          __csim_storageRemove(kind, String(k));
        },
        clear() {
          __csim_storageClear(kind);
        }
      };
    }
    ...
    globalThis.navigator = {
      ...
      clipboard: {
        ...
        readText() {
          return Promise.resolve(__clipboardText);
        },
    ...
    globalThis.btoa = function btoa(data) {
      ...
      for (let i = 0; i < s.length; i += 3) {
        ...
        out += __B64_CHARS[b1] + __B64_CHARS[b2] + (b3 === 64 ? "=" : __B64_CHARS[b3]) + (b4 === 64 ? "=" : __B64_CHARS[b4]);
      }
      return out;
    };
    ...
    globalThis.URL = function URL2(input, base) {
    ...
    Object.defineProperties(globalThis.URL.prototype, {
      href: {
        get() {
          return __csimUrlBuildHref(this);
        },
        set(v) {
      ...
      search: {
        ...
        set(v) {
          this._search = __csimUrlNormSearch(v);
          this.searchParams = new URLSearchParams(this._search);
        }
      },
      hash: { get() {
        ...
        this._hash = __csimUrlNormHash(v);
      } },
      origin: { get() {
        return this._origin;
      } }
    ...
    globalThis.URLSearchParams = function URLSearchParams2(init) {
      this._entries = [];
    ...
    Object.defineProperties(globalThis.URLSearchParams.prototype, {
      ...
      entries: { value: function() {
        return this._entries[Symbol.iterator] ? this._entries[Symbol.iterator]() : this._entries.values();
      }, writable: true, configurable: true },
      keys: { value: function() {
    ...
    function __normaliseHeaderName(k) {
    ...
    Object.defineProperties(globalThis.Headers.prototype, {
      ...
      delete: { value: function(k) {
        this._map.delete(__normaliseHeaderName(k));
      }, writable: true, configurable: true },
      get: { value: function(k) {
        const v = this._map.get(__normaliseHeaderName(k));
        return v == null ? null : v;
      }, writable: true, configurable: true },
      has: { value: function(k) {
        return this._map.has(__normaliseHeaderName(k));
      }, writable: true, configurable: true },
      set: { value: function(k, v) {
        this._map.set(__normaliseHeaderName(k), String(v));
      }, writable: true, configurable: true },
      forEach: { value: function(fn) {
    ...
    function __collectTabbables() {
      ...
      if (globalThis.document) walk2(globalThis.document);
      return out;
    }
    ...
    function labeledControlFor(label) {
      ...
      if (forId) {
        ...
        if (root) {
          const hit = __csimSelectFirst([root], "#" + forId);
          if (hit) return hit;
        }
      }
    ...
    function __csimXhrResponseValue(responseType, text, bytes, contentType) {
      switch (responseType) {
        case "arraybuffer":
          return __csimBytesToArrayBuffer(bytes);
        case "blob":
    ...
    CsimXMLHttpRequest.prototype.send = function(body) {
      ...
      const doFetch = () => {
        ...
        if (typeof self._url === "string" && self._url.startsWith("blob:")) {
          ...
          self.responseText = bytes2;
          self.response = __csimXhrResponseValue(self.responseType, bytes2, bytes2, contentType2);
          self._respHeaders = r ? { "content-type": contentType2 } : {};
          self.readyState = 4;
          self._fireReady();
    ...
    CsimXMLHttpRequest.prototype._fireEvent = function(type) {
      ...
      if (typeof handler === "function") {
        try {
          handler.call(this, { type, target: this, currentTarget: this });
        } catch (_) {
        }
      }
      const list = this._listeners[type];
      if (list) for (const h of list.slice()) {
        try {
          h.call(this, { type, target: this, currentTarget: this });
        } catch (_) {
        }
      }
    };
    ...
    if (typeof EventSource === "undefined") {
      const __csim_eventSourceById = /* @__PURE__ */ new Map();
      globalThis.__csim_eventSourceById = __csim_eventSourceById;
      class EventSource2 extends globalThis.EventTarget {
      ...
      globalThis.__csim_deliverEventSourceEvents = function(events) {
        ...
        for (const e of events) {
          ...
          if (e.type === "__open") {
            if (src.readyState === 0) {
              src.readyState = 1;
              const evt2 = new Event("open");
              src.dispatchEvent(evt2);
              try {
                if (typeof src.onopen === "function") src.onopen.call(src, evt2);
              } catch (_) {
              }
              delivered++;
            }
          ...
          if (e.type === "__error") {
            src.readyState = 2;
            const evt2 = new Event("error");
            if (e.message) try {
              evt2.message = String(e.message);
            } catch (_) {
            }
            src.dispatchEvent(evt2);
            try {
              if (typeof src.onerror === "function") src.onerror.call(src, evt2);
            } catch (_) {
            }
          ...
          if (type === "message") {
            try {
              if (typeof src.onmessage === "function") src.onmessage.call(src, evt);
            } catch (_) {
            }
          }
          delivered++;
    ...
    if (!globalThis.__csim_isWorker) {
      globalThis.__csim_installWorker = function() {
        ...
        const __csim_workersByHandle = /* @__PURE__ */ new Map();
        ...
        class Worker extends globalThis.EventTarget {
          ...
          postMessage(data, _transferList) {
            ...
            let payload;
            try {
              payload = __csimWorkerEncode(data);
            } catch (_) {
              payload = "null";
            }
        ...
        globalThis.__csim_deliverWorkerMessages = function(events) {
          ...
          for (const e of events) {
            ...
            if (e.kind === "__error") {
              ...
              w.dispatchEvent(evt);
              try {
                if (typeof w.onerror === "function") w.onerror.call(w, evt);
              } catch (_) {
              }
            } else {
              let data;
              try {
                data = __csimWorkerDecode(e.data);
              } catch (_) {
                data = null;
              }
              ...
              w.dispatchEvent(evt);
              try {
                if (typeof w.onmessage === "function") w.onmessage.call(w, evt);
              } catch (_) {
              }
            }
            n++;
    ...
    globalThis.__csim_workerOnMessage = function(dataStr) {
      let data;
      try {
        data = __csimWorkerDecode(dataStr);
      } catch (_) {
        data = null;
      }
      const evt = new MessageEvent("message", { data });
      ...
      try {
        if (typeof globalThis.onmessage === "function") globalThis.onmessage.call(globalThis, evt);
      } catch (_) {
      }
    };
    ...
    if (typeof indexedDB === "undefined") {
      ...
      const __csim_idbStore = /* @__PURE__ */ new Map();
      ...
      class IDBObjectStore extends IDBEventTarget {
        ...
        get(key) {
          ...
          const v = __csim_idbStore.get(this._name + "\0" + String(key));
          req.result = v;
        ...
        put(value, key) {
          const req = new IDBRequest();
          __csim_idbStore.set(this._name + "\0" + String(key), value);
          req.result = key;
          Promise.resolve().then(() => req.dispatchEvent({ type: "success", target: req }));
          return req;
        }
        delete(key) {
          const req = new IDBRequest();
          __csim_idbStore.delete(this._name + "\0" + String(key));
          Promise.resolve().then(() => req.dispatchEvent({ type: "success", target: req }));
          return req;
        }
        clear() {
          ...
          for (const k of Array.from(__csim_idbStore.keys())) {
            if (k.startsWith(this._name + "\0")) __csim_idbStore.delete(k);
          }
          Promise.resolve().then(() => req.dispatchEvent({ type: "success", target: req }));
          return req;
        }

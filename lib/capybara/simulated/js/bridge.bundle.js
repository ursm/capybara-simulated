(() => {
  ...
  function drainChildRealms(maxMs, maxIter, r) {
    ...
    if (!ids || !ids.size || typeof globalThis.__mr_realmGlobal !== "function") return;
    for (const id of ids) {
      try {
        const g = globalThis.__mr_realmGlobal(id);
  ...
  globalThis.__csimReportCallbackError = function(cb, e) {
    try {
      if (typeof cb === "function" && typeof globalThis.__mr_realmOf === "function" && typeof globalThis.__mr_realmGlobal === "function") {
        const id = globalThis.__mr_realmOf(cb);
        if (id != null) {
          const g = globalThis.__mr_realmGlobal(id);
  ...
  (function() {
    ...
    globalThis.__csimFrameWindow = function(frameEl) {
      ...
      if (frameEl._frameRealmId != null && typeof __mr_realmGlobal === "function") {
        return __mr_realmGlobal(frameEl._frameRealmId);
      }
      ...
      if (typeof globalThis.__csim_createFrameRealm === "function" && typeof __mr_realmGlobal === "function") {
        ...
        if (id != null) {
          ...
          const win2 = __mr_realmGlobal(id);
          try {

(() => {
  ...
  function installHtmlParser({ Document: Document2, Element: Element2, Text: Text2, Comment: Comment2, DocumentFragment: DocumentFragment2, DocumentType: DocumentType2, createHtmlPageDocument: createHtmlPageDocument2, registerFormName: registerFormName2 }) {
    ...
    function applyAttributes(el, rest, foreign) {
      ...
      while ((m = re.exec(rest)) !== null) {
        ...
        el._attrs[k] = dv;
        if (k === "id" || k === "name") registerFormName2(el, dv);
      }
    }
  ...
  function makeTagCtor(tag, Element2) {
    ...
    const match = Array.isArray(tag) ? (obj) => obj != null && obj._ns === HTML_NS2 && tag.indexOf(obj._localName) !== -1 : (obj) => obj != null && obj._ns === HTML_NS2 && obj._localName === tag;
  ...
  function installDomClassAliases({ Element: Element2, Document: Document2, Text: Text2 }) {
    ...
    }
    {
      ...
      Object.defineProperty(ctor, Symbol.hasInstance, {
        value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS2 && obj._localName != null && !KNOWN_HTML_TAGS.has(obj._localName), "value")
      });
    ...
    Object.defineProperty(HTMLElement, Symbol.hasInstance, { value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS2, "value") });
  ...
  var Element = class _Element extends Node {
    ...
    setAttribute(name, value) {
      ...
      this._attrs[n] = next;
      if ((n === "id" || n === "name") && next) registerFormName(this, next);
    ...
    setAttributeNS(namespace, qualifiedName, value) {
      ...
      if (rns === null && (localName === "id" || localName === "name") && next) registerFormName(this, next);
    ...
    _setAttrNodeValue(key, value) {
      ...
      if ((key === "id" || key === "name") && value) registerFormName(this, value);
      recordAttrMutation(this, key, old == null ? null : old);
    ...
    _bindAttrNode(attr) {
      ...
      if (!hasNs && (key === "id" || key === "name") && attr._value) registerFormName(this, attr._value);
    ...
    get relList() {
      ...
      if (ns === HTML_NS3 && (ln === "a" || ln === "area" || ln === "link" || ln === "form") || ns === SVG_NS2 && ln === "a") return tokenListFor(this, "rel");
      return void 0;
    }
    get sandbox() {
  ...
  var { parseDocument, parseFragment } = installHtmlParser({ Document, Element, Text, Comment, DocumentFragment, DocumentType, createHtmlPageDocument, registerFormName });

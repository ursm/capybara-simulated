(() => {
  ...
  function dispatchPath(target, event, drain) {
    ...
    try {
      ...
      if (event.type === "click" && !event._csimActivationHandled && event instanceof MouseEvent && target.nodeType === NODE_ELEMENT && target._tag === "input") {
        const itype = (target._attrs.type || "").toLowerCase();
        if (itype === "checkbox") {
          ckActivation = { kind: "checkbox", wasChecked: target._attrs.checked != null };
          toggleChecked(target);
        } else if (itype === "radio") {
          ckActivation = { kind: "radio", prevChecked: checkedRadioInGroup(target) };
          setRadio(target);
        }
      }
      event.eventPhase = 1;
      ...
      if (ckActivation) {
        if (event.defaultPrevented) {
          if (ckActivation.kind === "radio") {
            delete target._attrs.checked;
            if (ckActivation.prevChecked) ckActivation.prevChecked._attrs.checked = "";
          } else if (ckActivation.wasChecked) {
            target._attrs.checked = "";
          } else {
            delete target._attrs.checked;
          }
        } else {
          const wasChecked = ckActivation.kind === "radio" ? ckActivation.prevChecked === target : ckActivation.wasChecked;
          if (isConnected(target) && target._attrs.checked != null !== wasChecked) {
            try {
              dispatchEvent(target, new InputEvent("input", { bubbles: true, cancelable: true }));
            } catch (_) {
            }
            try {
              dispatchEvent(target, new Event("change", { bubbles: true, cancelable: false }));
            } catch (_) {
            }
          }
        }
  ...
  function installHtmlParser({ Document: Document2, Element: Element2, Text: Text2, DocumentFragment: DocumentFragment2, DocumentType: DocumentType2 }) {
    ...
    function findStructuralTag(html, want, from) {
      const re = new RegExp(
        "<!--[\\s\\S]*?-->|<script\\b[^>]*>[\\s\\S]*?<\\/script\\s*>|<style\\b[^>]*>[\\s\\S]*?<\\/style\\s*>|<(" + want + ")\\b([^>]*)>",
        "gi"
      );
      re.lastIndex = from || 0;
    ...
    function stripHtmlWrapper(html) {
      ...
      if (bodyTag) {
        ...
        const htmlMatch2 = /<html\b([^>]*)>/i.exec(pre);
        const headMatch2 = /<head\b([^>]*)>/i.exec(pre);
        const head = pre.replace(/<!doctype[^>]*>/i, "").replace(/<\/?html\b[^>]*>/gi, "").replace(/<\/?head\b[^>]*>/gi, "");
        ...
        return {
          head,
          body,
          htmlAttrs: htmlMatch2 ? htmlMatch2[1] : "",
          headAttrs: headMatch2 ? headMatch2[1] : "",
      ...
      return {
        head: headMatch ? headMatch[2] : "",
        htmlAttrs: htmlMatch ? htmlMatch[1] : "",
        headAttrs: headMatch ? headMatch[1] : "",
        bodyAttrs: "",
        implicitHead: !headMatch,
    ...
    function applyAttributes(el, rest) {
      ...
      while ((m = re.exec(rest)) !== null) {
        ...
        if (slow) el.setAttribute(m[1], decodeEntities(v));
        else el._attrs[asciiLowerAttr(m[1])] = decodeEntities(v);
      }
    }
  ...
  function drainChildRealms(maxMs, maxIter, r) {
    ...
    if (!ids || !ids.size || !globalThis.MiniRacer || typeof globalThis.MiniRacer.realmGlobal !== "function") return;
    for (const id of ids) {
      try {
        const g = globalThis.MiniRacer.realmGlobal(id);
  ...
  function makeTagCtor(tag, Element2) {
    ...
    const match = Array.isArray(tag) ? (obj) => obj != null && obj._ns === HTML_NS && tag.indexOf(obj._localName) !== -1 : (obj) => obj != null && obj._ns === HTML_NS && obj._localName === tag;
  ...
  function installDomClassAliases({ Element: Element2, Document: Document2, Text: Text2 }) {
    ...
    }
    {
      ...
      Object.defineProperty(ctor, Symbol.hasInstance, {
        value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS && obj._localName != null && !KNOWN_HTML_TAGS.has(obj._localName), "value")
      });
    ...
    Object.defineProperty(HTMLElement, Symbol.hasInstance, { value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === HTML_NS, "value") });
    class SVGElement extends Element2 {
      static {
        __name(this, "SVGElement");
      }
    }
    Object.defineProperty(SVGElement, Symbol.hasInstance, { value: /* @__PURE__ */ __name((obj) => obj != null && obj._ns === SVG_NS, "value") });
  ...
  var Element = class _Element extends Node {
    ...
    get attributes() {
      ...
      const dropUppercase = el._ns === HTML_NS2 && isHtmlDocument(el.ownerDocument);
    ...
    get relList() {
      ...
      if (ns === HTML_NS2 && (ln === "a" || ln === "area" || ln === "link" || ln === "form") || ns === SVG_NS2 && ln === "a") return tokenListFor(this, "rel");
      return void 0;
    }
    get sandbox() {
    ...
    get implementation() {
      return {
        ...
        createDocument: /* @__PURE__ */ __name((...args) => {
          ...
          d._contentType = ns === HTML_NS2 ? "application/xhtml+xml" : ns === SVG_NS2 ? "image/svg+xml" : "application/xml";
          d._children = newChildList();
          d.documentElement = null;
          d.readyState = "complete";
          if (doctype != null) {
  ...
  var TextDecoder = class {
    ...
    decode(input) {
      ...
      switch (this._dec) {
        ...
        // punctuation via the cp1252 table (the 5 undefined slots fall through to
        // the byte value). Also the decode target for iso-8859-1 / ascii labels.
        case "windows-1252": {
          const parts = [];
  ...
  globalThis.__csimReportCallbackError = function(cb, e) {
    try {
      if (typeof cb === "function" && globalThis.MiniRacer && typeof globalThis.MiniRacer.realmOf === "function" && typeof globalThis.MiniRacer.realmGlobal === "function") {
        const id = globalThis.MiniRacer.realmOf(cb);
        if (id != null) {
          const g = globalThis.MiniRacer.realmGlobal(id);
  ...
  if (globalThis.MiniRacer && typeof globalThis.MiniRacer.onUnhandledRejection === "function") {
    globalThis.MiniRacer.onUnhandledRejection(function(reason, promise) {
      try {
  ...
  (function() {
    ...
    globalThis.__csimFrameWindow = function(frameEl) {
      ...
      if (frameEl._frameRealmId != null && globalThis.MiniRacer && typeof globalThis.MiniRacer.realmGlobal === "function") {
        return globalThis.MiniRacer.realmGlobal(frameEl._frameRealmId);
      }
      ...
      if (typeof globalThis.__csim_createFrameRealm === "function" && globalThis.MiniRacer && typeof globalThis.MiniRacer.realmGlobal === "function") {
        ...
        if (id != null) {
          ...
          const win2 = globalThis.MiniRacer.realmGlobal(id);
          try {

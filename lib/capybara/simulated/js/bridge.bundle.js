(() => {
    ...
    globalThis.__csim_deliverEventSourceEvents = function(events) {
      ...
      for (const e of events) {
        ...
        if (e.type === "__open") {
          if (src.readyState === 0) {
            src.readyState = 1;
            const evt2 = new globalThis.Event("open");
        ...
        if (e.type === "__error") {
          src.readyState = 2;
          const evt2 = new globalThis.Event("error");
          if (e.message) try {
        ...
        const evt = new globalThis.MessageEvent(type, {
  ...
  (function() {
    ...
    if (typeof EventSource === "undefined") install();

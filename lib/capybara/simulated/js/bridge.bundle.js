(() => {
  ...
  function buildEnumMap(keywords, nonCanon) {
    ...
    for (const k of keywords) m.set(k.toLowerCase(), k);
    if (nonCanon) for (const nc in nonCanon) m.set(nc.toLowerCase(), nonCanon[nc]);
    return m;
  }
  ...
  function enumReflectGet(raw, map, missingDefault, invalidDefault) {
    ...
    const c = map.get(String(raw).toLowerCase());
  ...
  function reflectUnsignedLongSet(el, attr, v) {
    el.setAttribute(attr, String(v >>> 0));
  }
  ...
  var Element = class _Element extends Node {
    ...
    get formAction() {
      return FORMACTION_REFLECTING_TAGS.has(this._tag) ? reflectURLAttr(this, "formaction", FORMACTION_REFLECTING_TAGS) : "";
    }
    set formAction(v) {
    ...
    set size(v) {
      if (this._tag === "input") {
        reflectLimitedUnsignedLongSet(this, "size", v);
        return;
      }
      if (this._tag === "select") {
        reflectUnsignedLongSet(this, "size", v);
        return;
      }
    ...
    set height(v) {
      ...
      reflectUnsignedLongSet(this, "height", v);
    }
    get width() {
    ...
    set width(v) {
      ...
      reflectUnsignedLongSet(this, "width", v);
    }
    ...
    set colSpan(v) {
      if (this._tag === "td" || this._tag === "th") reflectUnsignedLongSet(this, "colspan", v);
    }
    get rowSpan() {
      return this._tag === "td" || this._tag === "th" ? reflectClampedUnsignedLongGet(this._attrs.rowspan, 1, 0, 65534) : void 0;
    }
    set rowSpan(v) {
      if (this._tag === "td" || this._tag === "th") reflectUnsignedLongSet(this, "rowspan", v);
    }
    get span() {
      return this._tag === "col" || this._tag === "colgroup" ? reflectClampedUnsignedLongGet(this._attrs.span, 1, 1, 1e3) : void 0;
    }
    set span(v) {
      if (this._tag === "col" || this._tag === "colgroup") reflectUnsignedLongSet(this, "span", v);
    }
    ...
    set hspace(v) {
      if (HVSPACE_TAGS.has(this._tag)) reflectUnsignedLongSet(this, "hspace", v);
    }
    get vspace() {
      return HVSPACE_TAGS.has(this._tag) ? reflectUnsignedLongGet(this._attrs.vspace, 0) : void 0;
    }
    set vspace(v) {
      if (HVSPACE_TAGS.has(this._tag)) reflectUnsignedLongSet(this, "vspace", v);
    }
    ...
    set scrollAmount(v) {
      if (this._tag === "marquee") reflectUnsignedLongSet(this, "scrollamount", v);
    }
    get scrollDelay() {
      return this._tag === "marquee" ? reflectUnsignedLongGet(this._attrs.scrolldelay, 85) : void 0;
    }
    set scrollDelay(v) {
      if (this._tag === "marquee") reflectUnsignedLongSet(this, "scrolldelay", v);
    }
    get rev() {

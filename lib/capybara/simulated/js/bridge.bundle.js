(() => {
  ...
  function cascadedProperty(el, prop) {
    ...
    if (sr) {
      const srRules = scopedLayoutRulesFor(sr);
  ...
  function scopedLayoutRulesFor(sr) {
    ...
    const addSheet = /* @__PURE__ */ __name((cssText) => {
      ...
      for (const r of parsed.layout) out.push({ ...r, source: r.source + serial });
      serial += parsed.count;
    }, "addSheet");
  ...
  __name(scopedLayoutRulesFor, "scopedLayoutRulesFor");

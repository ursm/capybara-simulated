...
class Node {
  ...
  blur() {
    ...
    try { dispatchEvent(this, new FocusEvent('blur',     { bubbles: false, cancelable: false, composed: true })); } catch (_) {}
    try { dispatchEvent(this, new FocusEvent('focusout', { bubbles: true,  cancelable: false, composed: true })); } catch (_) {}
  }

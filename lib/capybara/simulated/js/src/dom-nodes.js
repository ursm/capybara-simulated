...
class Element extends Node {
  ...
  // tagName / nodeName: the qualified name, ASCII-uppercased for HTML-namespace
  // elements in an HTML document (all our elements live in the HTML main doc).
  get tagName() {
    const qn = this._prefix ? this._prefix + ':' + this._localName : this._localName;
    return this._ns === HTML_NS ? qn.toUpperCase() : qn;
  }

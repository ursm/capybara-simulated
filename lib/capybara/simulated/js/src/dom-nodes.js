...
import { ensureInView, rectOf, clientRectsOf, clientBoxOf, documentBoxOf, paddingBoxOriginOf, viewportSize, contentExtent, isPositionedElement, scrollTargetFor, clampScrollOffset, hitTest, bumpScrollEpoch } from './layout.js';
...
class Node {
  ...
  get offsetParent() {
    ...
    if (this._lb && this._lb.fixed) return null;

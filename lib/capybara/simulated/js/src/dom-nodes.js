...
import { decodeDataUrlCss, SYSTEM_COLORS } from './css-utils.js';
import { buildOwnedStyleSheet }  from './cssom.js';
...
class ProcessingInstruction extends CharacterData {
  ...
  get sheet() {
    ...
    if (!this._sheet) {
      let css = '';
      const dataCss = decodeDataUrlCss(href);   // `data:text/css[;base64],<css>` (null if not a data: CSS URL)
      if (dataCss != null) css = dataCss;
      else { try { css = globalThis.__csimExternalAsset(href) || ''; } catch (_) {} }
      this._sheet = buildOwnedStyleSheet(css, { baseURL: href });
  ...
  get sheet() {
    ...
    if (this._tag === 'link') {
      ...
      if (!this._sheet) {
        ...
        this._sheet = buildOwnedStyleSheet(css, { baseURL: href, media: this._attrs.media });
        this._sheet.ownerNode = this;
      }
      return this._sheet;
    }

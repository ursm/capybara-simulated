...
import { isContenteditable, toggleChecked, setRadio, checkedRadioInGroup, uncheckOtherRadios, forEachRadioInGroup, isSubmitButton, formForControl, closeDialog, labeledControlFor, isLabelableControl, isHtmlLabel, labelToActivateFor, LABELABLE } from './form-helpers.js';
...
class Element extends Node {
  ...
  _cloneShell() {
    ...
    if (this._tag === 'input' || this._tag === 'textarea') {
      ...
      if (this._defaultChecked !== undefined)   e._defaultChecked = this._defaultChecked;
    ...
    if (tag === 'input' || tag === 'textarea' || tag === 'select') {
      ...
      if (type === 'radio') {
        ...
        if (this._attrs.name) {
          ...
          let groupChecked  = this._attrs.checked != null;
          forEachRadioInGroup(this, (o) => {
            if (o._attrs.required != null) groupRequired = true;
            if (o._attrs.checked  != null) groupChecked  = true;
          });

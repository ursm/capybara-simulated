...
import { isLaidOutNode, isUnskippedNode, visibilityHidden, INVISIBLE_TAGS, selfHidden, cascadedProperty, scheduleCascadeRefresh, bumpCascadeVersion, bumpCtxAll, styleElementIsCss } from './cascade.js';
...
class Element extends Node {
  ...
  get sheet() {
    if (this._tag === 'style') {
      ...
      if (!styleElementIsCss(this)) { this._sheet = null; return null; }

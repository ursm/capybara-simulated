...
import { ceState, getCustomElementCtor, ceUpgradeTree, fireCEDisconnect, fireCEMoveReactions, fireAttrChangedCallback, askForReset, askForResetBatch, askForResetAfterRemoval, runSelectednessAlgorithm, finalizeSelectOptions, ensureOptionSelInit, selectDisplaySize, updateSelectedContent } from './custom-elements.js';
...
function runComboboxFilter(input) {
  ...
  const ctrl = root && root.getElementById ? root.getElementById(id) : null;
  let opts;

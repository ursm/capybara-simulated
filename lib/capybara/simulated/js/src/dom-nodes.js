...
// browsers expose them as enumerable: true). Class `get`/`set` accessors default
// to non-enumerable, so re-flag the HTML declarative-shadow `<template>`
// reflection group enumerable to match the spec / feature-detection convention
// (shadowrootadoptedstylesheets-idl-feature-detection asserts it on
// HTMLTemplateElement.prototype, which is Element.prototype here).

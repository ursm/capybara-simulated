...
import { rectOf, documentBoxOf, viewportSize, contentExtent, isPositionedElement, scrollTargetFor, hitTest } from './layout.js';
...
function __notifyScroll(target) {
  ...
  try {
    if (typeof globalThis.__recheckIntersectionObservers === 'function') {
      globalThis.__recheckIntersectionObservers(true);   // a scroll moves boxes without a new generation
    }
  } catch (_) {}
}

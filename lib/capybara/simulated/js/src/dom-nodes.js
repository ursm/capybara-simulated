...
class Element extends Node {
  ...
  set cite(v) { if (CITE_REFLECTING_TAGS.has(this._tag)) this.setAttribute('cite', String(v)); }
  get poster()  { return reflectURLAttr(this, 'poster', POSTER_REFLECTING_TAGS); }
  set poster(v) { if (this._tag === 'video') this.setAttribute('poster', String(v)); }
  get longDesc()  { return reflectURLAttr(this, 'longdesc', LONGDESC_REFLECTING_TAGS); }
  set longDesc(v) { if (LONGDESC_REFLECTING_TAGS.has(this._tag)) this.setAttribute('longdesc', String(v)); }
  ...
  set data(v) { if (this._tag === 'object') this.setAttribute('data', String(v)); else reflectExpandoFallback(this, 'data', v); }
  get codeBase()  { return this._tag === 'object' ? reflectURLAttr(this, 'codebase', OBJECT_URL_TAGS) : undefined; }
  set codeBase(v) { if (this._tag === 'object') this.setAttribute('codebase', String(v)); else reflectExpandoFallback(this, 'codeBase', v); }
  // img.lowsrc (obsolete USVString URL).
  get lowsrc()  { return reflectURLAttr(this, 'lowsrc', LOWSRC_REFLECTING_TAGS); }
  set lowsrc(v) { if (this._tag === 'img') this.setAttribute('lowsrc', String(v)); }
  set src(v) {
    const next = String(v);
  ...
  set formAction(v) { this.setAttribute('formaction', String(v)); }
  ...
  set ping(v) { this.setAttribute('ping', String(v)); }

...
import { ensureInView, rectOf, clientRectsOf, clientBoxOf, documentBoxOf, paddingBoxOriginOf, viewportSize, contentExtent, isPositionedElement, isFixedElement, applyScrollIntoView, clampScrollOffset, hitTest, bumpScrollEpoch } from './layout.js';
...
class Node {
  ...
  get clientWidth()  { return this._isRootElement() ? viewportSize().width  : Math.round(clientBoxOf(this).width); }
  get clientHeight() { return this._isRootElement() ? viewportSize().height : Math.round(clientBoxOf(this).height); }

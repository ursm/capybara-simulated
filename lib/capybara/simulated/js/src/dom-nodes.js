  ...
  get dataset() {
    ...
    this._datasetProxy = new Proxy(Object.create(DOMStringMap.prototype), {
      get(t, key, recv) {
        ...
        // attribute maps to the name `Foo`).
      ...
      set(t, key, value, recv) {
        ...
        // setAttribute validates the resulting name (XML Name production) and
        // throws InvalidCharacterError for e.g. an embedded space.
      ...
      has(t, key) {
        if (typeof key === 'string' && roundTrips(key) &&
            Object.prototype.hasOwnProperty.call(el._attrs, toAttr(key))) return true;
...
installReflectedTail(REFLECT_STRING_TABLE,
  (attr, tagSet) => function () { return tagSet.has(this._tag) ? (this._attrs[attr] == null ? '' : String(this._attrs[attr])) : ''; },

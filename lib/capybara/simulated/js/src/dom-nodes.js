...
import { isVisibleNode, isLaidOutNode, INVISIBLE_TAGS, selfHidden, cascadedProperty, scheduleCascadeRefresh } from './cascade.js';
...
class ShadowRoot extends DocumentFragment {
  ...
  get adoptedStyleSheets() {
    return this._adoptedStyleSheets ||
      // invalidate the shadow cascade's cached rule set on any in-place mutation
      (this._adoptedStyleSheets = makeAdoptedStyleSheetsArray(() => { this._scopedRules = null; bumpStyleState(); }));
  }

...
import { walk, walkFind, walkSubtree, walkInclShadow, isConnected, scriptText, findById, setTemplateDocResolver } from './walk.js';
...
import { isVisibleNode, isLaidOutNode, INVISIBLE_TAGS, selfHidden, cascadedProperty, scheduleCascadeRefresh, bumpCascadeVersion } from './cascade.js';
...
class Element extends Node {
  ...
  set innerHTML(html) {
    ...
    if (this._tag === 'template') {
      ...
      frag._selEpoch = (frag._selEpoch || 0) + 1;   // direct child-list edit: move the context epoch too
...
class Document extends Node {
  ...
  open(...args) {
    ...
    if (body) {
      ...
      body._selEpoch = (body._selEpoch || 0) + 1;   // direct child-list edit: move the context epoch too
      bumpSettleGen();
    }
    return this;
  }

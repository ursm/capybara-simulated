...
class Element extends Node {
  ...
  get sheet() {
    if (this._tag === 'style') {
      ...
      } else if (this._sheetText !== text) {
        // Re-sync rules only when the element's text actually changed — otherwise the
        // existing CSSRule objects (and any CSSOM edits / expandos) must be preserved
        // for SameObject identity.

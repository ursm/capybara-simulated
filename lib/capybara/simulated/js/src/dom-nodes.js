...
const { parseXml } = installXmlParser({ Element, Text, Comment, ProcessingInstruction, CDATASection, DocumentType, DocumentFragment, finalizeElementProto });
...
const { parse5ParseIntoLive, parse5ParseFragment, parse5ParseDocument } = installParse5Adapter({
  ...
  windowForwardedHandlerName, activateWindowForwardedHandler, finalizeElementProto
});

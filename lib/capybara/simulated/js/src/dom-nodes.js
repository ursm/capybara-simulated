...
class Element extends Node {
  ...
  set valueAsNumber(v) {
    ...
    this.value = (v == null || Number.isNaN(v) || !Number.isFinite(v)) ? '' : numberToInputValue(type, v);
  }
  ...
  set valueAsDate(v) {
    ...
    if (v == null || !(v instanceof Date) || Number.isNaN(v.getTime())) { this.value = ''; return; }
  ...
  _stepBy(delta) {
    ...
    if (Math.abs(k - Math.round(k)) < EPS) {
      ...
      // Off the grid → snap to the nearest grid point in the step direction.

...
class ShadowRoot extends DocumentFragment {
  ...
  get adoptedStyleSheets() {
    return this._adoptedStyleSheets ||
      ...
      (this._adoptedStyleSheets = makeAdoptedStyleSheetsArray(() => { this._scopedRules = null; }));
  }
...
class ElementInternals {
  ...
  // CustomStateSet — a real Set backs `internals.states.add/delete/has/clear`. The
  // `:state(ident)` pseudo-class reads it (selectors.js), and because the cascade
  // re-matches on read, a state change is reflected in style with no explicit
  // invalidation. (A proper CustomStateSet brand + its parse/serialize edge cases
  // are a separate refinement.)

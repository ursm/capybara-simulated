...
// …and the shadow roots the cascade has yet to fold into its document-wide gates, for the same reason
// (no import cycle). Returns the queue and EMPTIES it: the caller folds what it takes, and holds no
// reference afterwards.
globalThis.__csimTakePendingShadowRoots = function () { return pendingShadowRoots.splice(0); };

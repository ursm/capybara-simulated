...
class Element extends Node {
  ...
  set height(v) {
    ...
    // Assigning a <canvas> width/height (even the same value) resets the bitmap
    // to transparent black — the `canvas.width = canvas.width` clear idiom, and
    // it keeps the backing buffer sized to the new dimensions.
    if (this._tag === 'canvas') this._pixels = null;
  }
  get width()   {
  ...
  set width(v)  {
    ...
    if (this._tag === 'canvas') this._pixels = null;   // reset the bitmap (see set height)
  }

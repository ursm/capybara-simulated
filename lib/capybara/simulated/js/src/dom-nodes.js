...
import { htmlCollection, nodeList }                                   from './dom-collections.js';
...
class Element extends Node {
  ...
  querySelectorAll(sel) { return nodeList(selectAll(this._children, sel, this)); }
...
class Document extends Node {
  ...
  querySelectorAll(sel) { return nodeList(this.documentElement ? selectAll([this.documentElement], sel, this.documentElement) : []); }

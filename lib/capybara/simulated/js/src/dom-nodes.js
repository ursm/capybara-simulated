...
class Element extends Node {
  ...
  get cols()  { return this._tag === 'textarea' ? reflectLimitedUnsignedLongGet(this._attrs.cols, 20) : undefined; }
  set cols(v) { if (this._tag === 'textarea') reflectLimitedUnsignedLongFallbackSet(this, 'cols', v, 20); }
  get rows()  { return this._tag === 'textarea' ? reflectLimitedUnsignedLongGet(this._attrs.rows, 2) : undefined; }
  set rows(v) { if (this._tag === 'textarea') reflectLimitedUnsignedLongFallbackSet(this, 'rows', v, 2); }

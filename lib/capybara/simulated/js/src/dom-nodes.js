...
globalThis.__csimSubmitFormToNamedFrame = function (form, submitter, entryList, fromSubmitMethod) {
  ...
  try {
    ...
    if (method === 'GET') {
      ...
      // cross-origin form target isn't CORS-blocked (submit-file posts to www1.*).
      promise = globalThis.fetch(actionUrl, { method: 'GET', mode: 'navigate' });
    } else {
      ...
      promise = globalThis.fetch(actionUrl, { method: 'POST', body: reqBody, mode: 'navigate' });
    }
    promise

...
import { recordAttrMutation, recordChildList, recordCharacterData, bumpSettleGen, bumpStyleState, currentSettleGen, signalSlotChange, setSlotChangeFirer, setSlotMutationHooks } from './mutation-observer.js';
...
class Element extends Node {
  ...
  get currentSrc()    { return this._tag === 'img' ? (this._imgComplete && this._attrs.src ? String(this._attrs.src) : '') : undefined; }

...
// the element so repeated reads return the same Attr (wgxpath / Capybara's
// `native.attributes` read `value` / `name` / `namespaceURI` / `prefix` /
// `localName` / `ownerElement` off it).

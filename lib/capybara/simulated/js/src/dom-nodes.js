...
class Element extends Node {
  ...
  set value(v)   {
    ...
    // untouched. No `select` event (so assign the offsets directly). The
    // selectionStart/End getters still gate on applicability, so this is
    // harmless for non-text input types.

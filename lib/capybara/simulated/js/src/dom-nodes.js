...
class Element extends Node {
  ...
  attachShadow(init) {
    ...
    // A QUEUE, not a registry: it is drained once and cleared, so nothing here keeps a discarded
    // component's subtree alive (see `shadowSheetFacts`).
...
class ShadowRoot extends DocumentFragment {
  ...
  get adoptedStyleSheets() {
    return this._adoptedStyleSheets ||
      ...
      (this._adoptedStyleSheets = makeAdoptedStyleSheetsArray(() => { this._scopedRules = null; bumpCascadeVersion(); }));
  }

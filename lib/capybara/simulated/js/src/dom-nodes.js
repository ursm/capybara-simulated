...
import { decodeDataUrlCss }      from './css-utils.js';
...
// CSS system colours (CSS Color 4 + legacy CSS2) — culori doesn't parse these
// keywords, so map them to light-theme sRGB hex. Used by `<input type=color>`
// sanitization (e.g. `value="ActiveBorder"` resolves rather than failing).
const SYSTEM_COLORS = {
  // CSS Color 4

...
class Node {
  ...
  submit() {
    ...
    // A submit targeting a named frame in this document is handled JS-side (the
    // navigation is contained to that child context); otherwise queue the Ruby
    // top-page submit path.
...
class Element extends Node {
  ...
  set value(v)   {
    ...
    this._attrs.value = (this._tag === 'input' || this._tag === 'textarea')
      ? (v === null ? '' : String(v))
      : String(v);
  }

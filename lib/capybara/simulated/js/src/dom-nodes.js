...
import { isContenteditable, toggleChecked, setRadio, checkedRadioInGroup, isSubmitButton, formForControl, closeDialog, labeledControlFor, isLabelableControl, isHtmlLabel, labelToActivateFor, LABELABLE } from './form-helpers.js';
...
class Element extends Node {
  ...
  get validity() {
    ...
    if (tag === 'input' || tag === 'textarea' || tag === 'select') {
      ...
      // A radio button with no (or empty) name isn't part of a radio group, so
      // `required` can't make it suffer from being missing.
      const radioNoName = type === 'radio' && !this._attrs.name;
      if (requiredApplies && this._attrs.required != null && empty && mutable && !radioNoName) v.valueMissing = true;

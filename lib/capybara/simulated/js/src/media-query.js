...
import { splitTopLevel, cssPropertyName, isSupportedCssPropertyName, isValidDeclarationValue } from './css-utils.js';
...
function evalSupportsFeature(text) {
  ...
  return isValidDeclarationValue(cssPropertyName(prop), value);
}

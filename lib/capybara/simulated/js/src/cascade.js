...
const LOWERCASE_VALUE_PROPS = new Set(['display', 'visibility', 'text-transform', 'white-space', 'direction']);
...
// captured set tight.
const LAYOUT_PROPS = [...CAPTURED_PROPS, 'text-transform', 'white-space', 'direction'];

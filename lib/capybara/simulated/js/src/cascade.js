...
// resource fails to load. Read by the layout walk (layout.js `layoutChildren`), the visibility
...
// `layoutChildren` call before it looks for generated content on an element.

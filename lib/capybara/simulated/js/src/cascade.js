...
const CAPTURED_PROPS = new Set(['top', 'left', 'width', 'height', 'color', 'background-color', 'position', 'z-index', 'border-width', 'border-style', 'border-color', 'outline-color', 'caret-color', 'font-size']);

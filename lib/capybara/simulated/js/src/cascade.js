...
const LOWERCASE_VALUE_PROPS = new Set(['display', 'visibility', 'text-transform', 'white-space', 'direction', 'appearance', 'text-align']);
...
const CAPTURED_PROPS = new Set(['top', 'left', 'width', 'height', 'color', 'background-color', 'position', 'z-index', 'border-width', 'border-style', 'border-color', 'outline-color', 'caret-color', 'font-size', 'font-weight', 'font-style', 'line-height', 'font-family', 'opacity', 'text-align', 'cursor', 'pointer-events']);

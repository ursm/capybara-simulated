...
// alongside __csimNativeShadowStats to report the match fraction of cascade time.
globalThis.__csimCascadeTimingStats = function (reset) {
  const snap = { cascMatchNs, cascMatchCalls, cascTotalNs, cascRuns };
  if (reset) { cascMatchNs = 0; cascMatchCalls = 0; cascTotalNs = 0; cascRuns = 0; }
  return snap;
};

...
class SubtleCrypto {
  ...
  encrypt()    { return Promise.reject(domError('encrypt is not yet implemented', 'NotSupportedError')); }
  decrypt()    { return Promise.reject(domError('decrypt is not yet implemented', 'NotSupportedError')); }

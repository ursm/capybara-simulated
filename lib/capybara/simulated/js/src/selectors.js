...
// query API. The hand-rolled cascade-rule engine in `bridge.entry.js`
// still drives the visibility / layout cascade — that path will
...
export function normaliseScopedSelector(sel) {

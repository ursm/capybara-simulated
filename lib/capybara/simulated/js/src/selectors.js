...
// css-select v7 doesn't know `:focus` / `:focus-within` / `:focus-visible`
// — they're CSS4 user-action pseudos. Wire them through the
// `options.pseudos` extension hook so `querySelectorAll(':focus-within')`
// and Capybara's `have_css('input:focus')` work uniformly.
const userPseudos = {

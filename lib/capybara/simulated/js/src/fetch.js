...
globalThis.__csimFetch = function (input, init, signal) {
  ...
  if (input instanceof Request && init.body == null && input._body != null) {
  ...
  const keepalive = init.keepalive != null ? !!init.keepalive : (input instanceof Request ? input.keepalive : false);

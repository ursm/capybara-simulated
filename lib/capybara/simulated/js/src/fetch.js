...
class Request {
  constructor(input, init) {
    ...
    this.referrerPolicy = init.referrerPolicy || (input instanceof Request ? input.referrerPolicy : '') || '';
...
globalThis.fetch = function fetch(input, init) {
  ...
  return new Promise(function (resolve, reject) {
    globalThis.setTimeout(function () {
      try {
        const resp = globalThis.__rackFetch(method.toUpperCase(), url, bodyStr, headers, 'follow', undefined, undefined, referrerPolicy);

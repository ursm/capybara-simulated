...
// HTML. `PromiseRejectionEvent` is intentionally NOT exposed as a
// global today (see bridge.entry.js) — without that exposure, core-js
// keeps polyfilling Promise, which has subtle timing differences that
// some apps depend on.

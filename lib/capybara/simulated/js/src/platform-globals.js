...
// thrown error's realm. mini_racer-csim's `MiniRacer.realmOf(fn)` gives that realm's
...
globalThis.__csimReportCallbackError = function (cb, e) {
  try {
    if (typeof cb === 'function' &&
        globalThis.MiniRacer &&
        typeof globalThis.MiniRacer.realmOf === 'function' &&
        typeof globalThis.MiniRacer.realmGlobal === 'function') {

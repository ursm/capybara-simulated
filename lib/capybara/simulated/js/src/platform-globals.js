...
// thrown error's realm. mini_racer-csim's `__mr_realmOf(fn)` gives that realm's
...
globalThis.__csimReportCallbackError = function (cb, e) {
  try {
    if (typeof cb === 'function' &&
        typeof globalThis.__mr_realmOf === 'function' &&
        typeof globalThis.__mr_realmGlobal === 'function') {

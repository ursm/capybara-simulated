...
function cloneInto(v, seen) {
  ...
  // (url/historical: "no structured serialize/deserialize support").
  if (tag === '[object URL]' || tag === '[object URLSearchParams]' ||
      (globalThis.URL && v instanceof globalThis.URL) ||
      (globalThis.URLSearchParams && v instanceof globalThis.URLSearchParams)) {

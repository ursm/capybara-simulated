...
function makeStorage(kind) {
  ...
  return new Proxy(self, {
    ...
    // is rejected. (Symbols / the API methods keep ordinary defineProperty behavior.)
    defineProperty(target, prop, desc) {
      if (typeof prop === 'symbol' || STORAGE_API_METHODS.has(prop)) return Reflect.defineProperty(target, prop, desc);

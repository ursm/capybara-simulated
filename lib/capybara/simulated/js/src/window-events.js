...
import { defaultPassiveValue, getWindowForwardedHandler, removeOnceListener } from './events.js';

const windowListeners = Object.create(null);

// Invoke the Window's event-handler IDL attribute (`window.onload`, also
// reflected by `body.onload`) for this event. HTML treats it as a bubble-phase
// listener, so it runs in the non-capture pass after addEventListener listeners.

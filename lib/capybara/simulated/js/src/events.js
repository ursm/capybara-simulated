...
export class ProgressEvent extends Event {
  ...
  constructor(type, init = {}) {
    super(type, init);
    Object.defineProperty(this, 'lengthComputable', { value: !!init.lengthComputable, writable: true, enumerable: true, configurable: true });
    Object.defineProperty(this, 'loaded', { value: Number(init.loaded) || 0, writable: true, enumerable: true, configurable: true });
    Object.defineProperty(this, 'total',  { value: Number(init.total)  || 0, writable: true, enumerable: true, configurable: true });

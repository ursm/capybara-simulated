...
export function defineEventHandler(proto, type) {
  ...
  Object.defineProperty(proto, 'on' + type, {
    configurable: true,
    get() { return typeof this[slot] === 'function' ? this[slot] : null; },
    set(v) {
      const cb  = typeof v === 'function' ? v : null;
      const had = typeof this[slot] === 'function';
      ...
      if (Object.prototype.hasOwnProperty.call(this, slot)) this[slot] = cb;
      else Object.defineProperty(this, slot, { value: cb, writable: true, enumerable: false, configurable: true });
      if (cb && !had) {

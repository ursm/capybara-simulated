...
class CustomElementRegistry {
  ...
  define(name, constructor, options) {
    ...
    // `:defined` flips for every existing element of this name. The cascade re-matches on read, so
    // style is already correct; a cached cascade result is not, and nothing else moves for a
    // definition (no attribute, no DOM change).
    bumpStyleState();

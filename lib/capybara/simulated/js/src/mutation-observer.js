...
export function recordAttrMutation(target, key, oldValue, meta) {
  ...
  if (lkey === 'align') globalThis.__csimLineAlignHint = true;   // see dom-nodes.js `LINE_ALIGN_TAGS`
  else if (lkey === 'dir') globalThis.__csimFlowHint = true;     // cascade.js `documentTurnsFlow`

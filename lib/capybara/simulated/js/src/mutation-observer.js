...
import { syncArenaChildList, syncArenaAttrs, syncArenaCharData } from './native-query-shadow.js';
...
export function recordAttrMutation(target, key, oldValue, meta) {
  syncArenaAttrs(target);   // shadow measurement: mirror the attr change into the arena (inert when off)

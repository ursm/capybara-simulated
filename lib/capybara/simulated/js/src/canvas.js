...
export class CanvasRenderingContext2D {
  ...
  _resetState() {
    ...
    // Shadow properties are stored (save/restore'd + read back) but not yet
    // rendered — a bounded gap; shadow rasterization is a later stage.
    this.shadowBlur               = 0;
  ...
  _drawText(text, x, y, maxWidth, obj, solid) {
    ...
    for (let my = 0; my < mhei; my++) {
      ...
      const maskRow = my * mwid, devRow = dy * cw;

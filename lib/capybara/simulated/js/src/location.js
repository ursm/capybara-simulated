...
// Per HTML spec, `window.location = X` is equivalent to
// `location.assign(X)`. Without a setter the assignment would silently
// rebind `globalThis.location` to the string.

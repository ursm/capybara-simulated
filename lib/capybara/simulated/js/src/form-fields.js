...
globalThis.__csimArrowKeyDefault = function (node, key) {
  ...
  if (tag === 'select' && node._attrs.multiple == null && (key === 'ArrowDown' || key === 'ArrowUp')) {
    const opts = node.querySelectorAll('option').filter((o) => !isActuallyDisabled(o));

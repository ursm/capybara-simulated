...
// The slot a shadow host's light child renders through — null for one no slot takes, which is in no flat tree.
export function assignedSlotFor(el) { return slotForStyling(el); }

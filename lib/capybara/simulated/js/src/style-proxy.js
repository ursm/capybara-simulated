...
//
// A `perspective()` is NOT modelled here: the divide is projective and this driver's geometry
// composes 2D affines end to end (`transformChain`). The flattening drops it, which leaves the box
// where the perspective's own translation puts it rather than where the projection would.
function flatten4(m) {

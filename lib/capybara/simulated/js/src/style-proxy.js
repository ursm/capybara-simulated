...
// A block's computed `tab-size`: a number of spaces, or a length in px (layout.js `tabStopOf`
// turns either into the stop width). Asked only of a block whose text holds a tab.

...
// `background-position`) and `text-align`, whose mdn initial is prose — have no generated entry
// at all, so they're listed rather than overridden.
...
const COMPUTED_INITIAL_OVERRIDES = Object.assign(Object.create(null), {
  ...
  'text-align': 'start', 'text-decoration': 'none', 'background-position': '0% 0%',
  'overflow': 'visible',
});
...
function readComputed(el, key) {
  ...
  return initial !== null ? { hit: true, value: initial } : { hit: false };
}

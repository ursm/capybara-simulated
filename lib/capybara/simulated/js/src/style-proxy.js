...
import { hasMathFunction, reduceMathFunctions } from './calc.js';
...
const CALC_VIEWPORT_ALIAS = { dvh: 'vh', svh: 'vh', lvh: 'vh', dvw: 'vw', svw: 'vw', lvw: 'vw' };
const CALC_FONT_UNITS = new Set(['em', 'ex', 'ch', 'rem']);

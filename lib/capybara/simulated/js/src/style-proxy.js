...
import { CSS_PROPERTY_BY_IDL_ATTRIBUTE, cssPropertyName, parseStyleDeclList, serializeCssValue, serializeFontFamily, SYSTEM_COLORS, ABSOLUTE_FONT_SIZE_PX, resolveCssUrls, documentBaseUrl, canonicalizeBgPosition, normalizeZeroLengths, splitTopLevel, isSupportedCssPropertyName, isValidDeclarationValue, htmlInteger } from './css-utils.js';
...
function animationEndpoint(el, key, declared) {
  ...
  return ANIMATION_TYPES[key] === 'color' ? normalizeColor(out) : out;
}

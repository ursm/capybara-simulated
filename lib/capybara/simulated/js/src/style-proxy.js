...
import { cascadedProperty, expandShorthandValue, twinName, matchesAnyHideRule, splitImportant, computedVisibility, ownDisplay, inlineDecls, cascadeDeclaresProperty, canExpandShorthand } from './cascade.js';
...
function setterLeavesUnknown(el, key) {
  ...
  for (const sh of setters) {
    ...
    if (!expandShorthandValue(sh, v)) return true;
  }
  return false;
}

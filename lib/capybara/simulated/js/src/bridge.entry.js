...
(function () {
  ...
  function swFetchSubresource(absUrl, destination, cors) {
    ...
    try { return globalThis.__csim_swScriptFetch(swCtrl, absUrl, cid, (globalThis.location && globalThis.location.href) || '', destination, c.mode, c.credentials) || null; } catch (_) { return null; }
  }
  function swFetchScript(absUrl, el) { return swFetchSubresource(absUrl, 'script', swCorsOf(el)); }
      ...
      if (src && src !== 'about:blank') {
        try {
          ...
          if (/^data:/i.test(frameUrl)) {
            ...
            const resp = globalThis.__csim_frameNavigationFetch(frameUrl, isReloadNav, navReferrer, __csimSecureAncestorChain(), 'GET', '', null, true);

...
(function () {
  ...
  globalThis.__csimFrameWindow = function (frameEl) {
    ...
    // test). So an empty/srcdoc frame's location.origin isn't yet the opaque
    // "null" (self-origin about:blank/srcdoc subtests stay in-scope backlog).
    let frameDocOrigin;
    ...
    if (typeof globalThis.__csim_createFrameRealm === 'function' && globalThis.RustyRacer && typeof globalThis.RustyRacer.contextGlobal === 'function') {
      ...
      const id = globalThis.__csim_createFrameRealm(frameUrl, body, contentType, parentId, frameEl.getAttribute('name'), frameDocOrigin);
      if (id != null) {

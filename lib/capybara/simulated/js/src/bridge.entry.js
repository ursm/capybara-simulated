...
(function () {
  ...
  // which would advance the driver's lazy clock: an unrelated `setTimeout(fn, 0)`
  // a page queued during parsing must still be PENDING when the visit returns
  // (smoke_spec's "queries the DOM before advancing pending timers").

...
import { deliverMutations, flushMutationDelivery, hasQueuedRecords, hasObservers, recordAttrMutation, recordChildList, signalSlotChildList } from './mutation-observer.js';
...
(function () {
  ...
  const __streamHooks = {
    onInsert(parent, node) {
      ...
      else signalSlotChildList(parent, [node], []);

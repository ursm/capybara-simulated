...
(function () {
  ...
  function runModuleScript(s) {
    ...
    // Resource Timing: every module the graph just fetched (the entry and each import) files a
    // 'script' entry — the loader collected them host-side as it fetched. One per URL (its handle
    // cache dedupes re-imports), recorded after the graph evaluated.
    if (typeof globalThis.__csim_takeModuleRt === 'function' && typeof globalThis.__csimRecordResource === 'function') {

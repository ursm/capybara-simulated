...
(function () {
  ...
  function assetTimingFields(url, body) {
    const meta = body != null && typeof globalThis.__csimExternalAssetMeta === 'function' ? globalThis.__csimExternalAssetMeta(url) : null;
  ...
  globalThis.__csimFrameWindow = function (frameEl) {
    ...
    if (navContent) {
      ...
      const reloadUrl = frameEl._frameReloadUrl || null;     // a reload keeps the document's current URL
      frameEl._frameReloadUrl = null;
      const src = reloadUrl || frameEl.getAttribute('src');

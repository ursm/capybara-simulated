...
(function () {
  ...
  // the target.
  globalThis.__csimDragOnto = function (sourceHandle, targetHandle, opts) {
    return dragOnto(__handles.get(sourceHandle), __handles.get(targetHandle), opts);
  };

...
import { isObscured, rectOf, applyScrollTo } from './layout.js';
...
(function () {
  ...
  // visible, fully out of the viewport, or a click at its in-view centre lands on a non-descendant
  // element on top. Backed by the pay-per-use coarse box-layout model; the public
  // getBoundingClientRect / elementFromPoint stay on their existing coarse model (a later increment).

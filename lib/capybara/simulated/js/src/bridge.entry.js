...
(function () {
  ...
  globalThis.__csimFrameWindow = function (frameEl) {
    ...
    if (typeof globalThis.__csim_createFrameRealm === 'function' && globalThis.RustyRacer && typeof globalThis.RustyRacer.contextGlobal === 'function') {
      ...
      const id = globalThis.__csim_createFrameRealm(frameLocationHref, body, contentType, parentId, frameEl.getAttribute('name'), frameDocOrigin, frameLocationOrigin, jsUrlSource, frameAboutBase, frameViewport);
      if (id != null) {

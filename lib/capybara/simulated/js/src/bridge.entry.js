...
import { install as installEventSource } from './event-source.js';
import { Event, DOMException, CustomEvent, MouseEvent, KeyboardEvent, InputEvent, SubmitEvent, MessageEvent, EventTarget } from './events.js';
import { AbortSignal, AbortController } from './abort.js';
import { installIfMissing as installIntlCollator } from './intl-collator.js';
import { installIfMissing as installIDB } from './idb.js';
...
(function () {
  ...
  if (typeof EventSource === 'undefined') installEventSource();

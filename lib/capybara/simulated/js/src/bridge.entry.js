...
(function () {
  ...
  function swFetchSubresource(absUrl, destination, cors, binary, integrity) {
    ...
    try { return globalThis.__csim_swScriptFetch(swCtrl, absUrl, cid, (globalThis.location && globalThis.location.href) || '', destination, c.mode, c.credentials, binary === true, integrity || '') || null; } catch (_) { return null; }
  }
  ...
  function swFetchStyle(absUrl) {
    ...
    const r = swFetchSubresource(absUrl, 'style', __swStyleCors.get(absUrl));

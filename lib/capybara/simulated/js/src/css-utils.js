...
export function parseStyleDeclList(src) {
  // A COMMENT is no part of any declaration, and the stylesheet reader drops every one (`ruleDecls`); read here it
  // was value text — `calc(10px /* c */ + 20px)` was mangled and dropped, `padding-left: 1px /* y */` invalid —
  // where Chrome computes 30px and 1px.

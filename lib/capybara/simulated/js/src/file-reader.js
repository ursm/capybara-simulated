...
import { ProgressEvent, EventTarget, dispatchWithOnHandler, defineEventHandlers } from './events.js';
...
defineEventHandlers(FileReader.prototype, ['loadstart', 'progress', 'load', 'abort', 'error', 'loadend']);

  ...
  function applyAttrs(el, attrs) {
    for (let i = 0; i < attrs.length; i++) {
      ...
      if (!Object.prototype.hasOwnProperty.call(el._attrs, name)) {
        ...
        if (name === 'align') globalThis.__csimLineAlignHint = true;   // see dom-nodes.js `LINE_ALIGN_TAGS`
        else if (name === 'dir') globalThis.__csimFlowHint = true;     // cascade.js `documentTurnsFlow`

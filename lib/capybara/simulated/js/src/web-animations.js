...
import { bumpCascadeVersion, expandShorthandValue } from './cascade.js';
...
export class KeyframeEffect extends AnimationEffect {
  ...
  set composite(v) { const name = String(v); if (COMPOSITE_OPERATIONS.has(name)) this._composite = name; }
  getKeyframes() {

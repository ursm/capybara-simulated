...
export function serializeRequestBody(body, headers) {
  ...
  // body"). We don't sync-serialize a stream body (the streams cluster is separate), but
  // it must not fall through to the USVString default below and gain a bogus text/plain.

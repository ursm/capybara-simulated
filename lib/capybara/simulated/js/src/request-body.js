...
export function serializeRequestBody(body, headers) {
  ...
  if (body instanceof globalThis.ArrayBuffer || (globalThis.ArrayBuffer.isView && globalThis.ArrayBuffer.isView(body))) {
    ...
    // only its own byteOffset/byteLength window, not the whole backing buffer.
    const u8 = body instanceof globalThis.ArrayBuffer
      ? new Uint8Array(body)

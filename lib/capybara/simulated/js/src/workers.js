  ...
  globalThis.__csim_installWorker = function () {
    ...
    class Worker extends EventTarget {
      constructor(url, _options) {
        ...
        // real origin) inherits this agent cluster's origin for BroadcastChannel scoping, and the
        // creating REALM so it inherits that context's service worker and dies with it.
        this._handle        = globalThis.__csim_workerSpawn(this.url, false, globalThis.__csimBcOriginKey(), globalThis.__csimRealmId()) | 0;

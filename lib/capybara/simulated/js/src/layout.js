...
const NL_STRIDE = 50;   // node record; must match layout::Input / LAYOUT_STRIDE
...
function nlTableSupported(el) {
  ...
  if (grid.captions.length || grid.columns.length || grid.outOfFlow.length) return false; // caption / col / out-of-flow → JS

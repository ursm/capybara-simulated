...
function nlFlexSupported(el) {
  ...
  // The CROSS-axis min/max clamps the container after stretch (two-phase), which native can't reproduce:
  // for a row the cross is height, for a column it is width. (The main-axis one — width for a row — native
  // clamps itself in resolve_width; for a column the main is height, bailed here with the cross-height.)

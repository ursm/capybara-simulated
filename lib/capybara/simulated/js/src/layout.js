...
function nlTableSupported(el) {
  ...
  // (…asked lazily: only a cell holding a percentage-height descendant needs it, and the answer for a table whose
  // height a parent imposed is the oracle's.)
  const imposedH = () => (el._lb && el._lb.autoHeight === false) || declaresLayoutProp(el, 'min-height');

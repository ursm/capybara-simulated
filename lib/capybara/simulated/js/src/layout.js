...
const REUSE_STATS = { hit: 0, escapingAbs: 0, rowAnchored: 0, floatsRepushed: 0, remeasured: 0 };
...
function layoutElement(el, box, ctx, cbW = box.width) {
  ...
  if (establishesBFC(el, displayOf(el))) ctx.floats = newFloatContext(el);
  try {

...
const NL_STRIDE = 55;   // node record; must match layout::Input / LAYOUT_STRIDE
...
globalThis.__csimLayoutShadowRun = function (rootEl) {
  ...
  if (!d.layoutPass(buf, runBuf, runTexts, root._lb.x, root._lb.y, rootCbW)) return { ok: false, reason: 'native declined' };

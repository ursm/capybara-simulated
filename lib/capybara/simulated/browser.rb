  ...
  module Simulated
    class Browser
      ...
      def dispose
        ...
        # Browser is the isolate's last owner, but dropping the last reference
        # reclaims nothing: the engine roots every attached host fn, and they
        # capture this Browser (see V8Runtime's `@@live`). Without this, each

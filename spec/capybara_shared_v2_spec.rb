...
module TestSessions
  SimulatedV2 = Capybara::Session.new(:simulated_v2, TestApp)
end
...
DESCRIPTION_SKIPS = [
  'Capybara::Session SimulatedV2 node #drag_to ',
  'Capybara::Session SimulatedV2 node #click should not retry clicking when wait is disabled'
].freeze
